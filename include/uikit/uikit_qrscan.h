 ...
 */
#ifndef __UIKIT_QRSCAN_H__
#define __UIKIT_QRSCAN_H__
 ...
 */
void* vg_qrscan_create(void);

/**
 * destroy the scanner
 * @param handle pointer to the initialized scanner
 */
void vg_qrscan_destory(void* handle);
 ...
 */
int vg_qrscan_scan(void* handle, int width, int height,
    uint8_t* in, char** out);
 ...
 */
void vg_yuyv_to_gray(const uint8_t* src, int src_pitch,
    int w, int h, uint8_t* dst, int dst_pitch);

/**
 * convert to gray image from NV12
 * @param src pointer to the NV12 buffer
 * @param w width of the NV12 image
 * @param h height of the NV12 image
 * @param dst pointer to the gray image buffer
 */
void vg_nv12_to_gray(const uint8_t* src, int w, int h, uint8_t* dst);
 ...
 * @param dst_pitch pitch between lines(gray: w)
 */
void vg_bgra8888_to_gray(const uint8_t* src, int src_pitch,
    int w, int h, uint8_t* dst, int dst_pitch);
 ...
 * @param dst pointer to the gray image buffer
 */
void vg_rgb565_to_gray(const uint8_t* src, int w, int h, uint8_t* dst);
 ...
 * @param dst pointer to the gray image buffer
 */
void vg_rgb332_to_gray(const uint8_t* src, int w, int h, uint8_t* dst);

#endif /* CONFIG_UIKIT_QRSCAN  */

#ifdef __cplusplus
}
#endif

#endif /* __UIKIT_QRSCAN_H__ */
